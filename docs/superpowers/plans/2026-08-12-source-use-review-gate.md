...
- [ ] **Step 3: Implement strict models and the decision function**
...
- [ ] **Step 1: Write failing streaming and artifact tests**
...
- [ ] **Step 1: Write failing blocked-path tests**
...
- [ ] **Step 2: Verify blocked tests fail**

Run: `pytest tests/corpus_intake/test_review_queue.py -q`

- [ ] **Step 3: Implement verified metadata inventory**
...
- [ ] **Step 4: Add failing synthetic approved-path tests**
...
- [ ] **Step 5: Implement blinded packet release**
...
- [ ] **Step 1: Write failing item/hash/frozen tests**
...
- [ ] **Step 2: Write failing CLI directory test**
...
- [ ] **Step 4: Implement validation and route CLI**
...
- [ ] **Step 4: Run all local checks before network access**
...
- [ ] **Step 5: Hash `data/gold`, then capture real evidence**

Hash all `data/gold` files. Run `polytrading collect source-use` into `var/source-use/2026-08-12-polymarket-v1` using the actual UTC retrieval time and a 2 MiB body cap.

- [ ] **Step 6: Generate and verify real blocked inventory**

Run `polytrading collect review-queue` with the open-v2 and closed-v2 intake directories, the new source-use run, output `var/review-queue/2026-08-12-polymarket-blocked-v1`, actual UTC `--as-of`, and ontology `candidate-triage-v1`.
